...
(function () {
    ...
    DashboardController.$inject = ['$scope', '$localStorage', '$uibModal', '$stateParams', '$state', 'data', '$http', 'toaster', 'SweetAlert', '$linkedIn', '$rootScope']

    function DashboardController($scope, $localStorage, $uibModal, $stateParams, $state, data, $http, toaster, SweetAlert, $linkedIn, $rootScope) {
        var vm = this;
