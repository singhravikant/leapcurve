...
(function () {
    ...
    angular
        .module('naut')
        .controller('DashboardControllerGoogle', DashboardControllerGoogle);

    DashboardControllerGoogle.$inject = ['$scope', '$localStorage', '$uibModal', '$stateParams', '$state', 'data', '$http', 'toaster', 'SweetAlert', '$linkedIn', '$rootScope']

    function DashboardControllerGoogle($scope, $localStorage, $uibModal, $stateParams, $state, data, $http, toaster, SweetAlert, $linkedIn, $rootScope) {
        var vm = this;
